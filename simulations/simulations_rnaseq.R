...
briggsae_fasta_file = 'briggsae.cds.fa'
nigoni_fasta_file = 'nigoni.cds.fa'

# read objects
briggsae_fasta = readDNAStringSet(briggsae_fasta_file)
nigoni_fasta = readDNAStringSet(nigoni_fasta_file)
...
species_readspertx_briggsae = round(40 * width(briggsae_fasta_small) / 100)
species_readspertx_nigoni = round(40 * width(nigoni_fasta_small) / 100)

# simulate briggsae reads
# three replicates each
print("simulating between species data")
simulate_experiment('briggsae.cds.small.fa',
                   reads_per_transcript=species_readspertx_briggsae,
                   num_reps=c(3,3),
                   fold_changes=species_fold_changes,
                   outdir='species_briggsae_simulated_reads',
                   paired=FALSE)
print("done for briggsae.cds.small.fa")
# simulate nigoni reads
simulate_experiment('nigoni.cds.small.fa',
                   reads_per_transcript=species_readspertx_nigoni,
                   num_reps=c(3,3),
                   fold_changes=species_fold_changes,
                   outdir='species_nigoni_simulated_reads',
                   paired=FALSE)
print("done for nigoni.cds.small.fa")
...
simulate_experiment('briggsae.cds.small.fa',
                   reads_per_transcript=allele_readspertx_briggsae,
                   num_reps=c(3,3),
                   fold_changes=allele_fold_changes,
                   outdir='allele_briggsae_simulated_reads',
                   paired=FALSE)
print("done for briggsae.cds.small.fa")
# simulate nigoni reads
simulate_experiment('nigoni.cds.small.fa',
                   reads_per_transcript=allele_readspertx_nigoni,
                   num_reps=c(3,3),
                   fold_changes=allele_fold_changes,
                   outdir='allele_nigoni_simulated_reads',
                   paired=FALSE)
print("done for nigoni.cds.small.fa")
