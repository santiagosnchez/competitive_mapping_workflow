...
paste Cbr_fc.counts.txt Cni_fc.counts.txt | tail -n +3 | cut -f7-12,19-24 | paste ../references/annotations/gene_names.txt - > species_counts.tx
cat head.txt species_counts > tmp && mv tmp species_counts.txt
